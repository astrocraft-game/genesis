...
pub fn generate_world_from_cosmos_body(
    ...
    let input = external_facts_to_world_input(&body.external_facts(star_age_gyr, moon_count, has_rings));
...
fn map_world_type(value: cosmos::prelude::CelestialBodyWorldType) -> CelestialBodyWorldType {
    match value {
        ...
        cosmos::prelude::CelestialBodyWorldType::DirtySnowball => CelestialBodyWorldType::DirtySnowball,
        ...
        cosmos::prelude::CelestialBodyWorldType::CarbonWorld => {
            CelestialBodyWorldType::CarbonWorld
        }
        ...
        cosmos::prelude::CelestialBodyWorldType::RoguePlanet => {
            CelestialBodyWorldType::RoguePlanet
        }
        cosmos::prelude::CelestialBodyWorldType::IronWorld => CelestialBodyWorldType::IronWorld,
        cosmos::prelude::CelestialBodyWorldType::MiniNeptune => {
            CelestialBodyWorldType::MiniNeptune
        }
    }
}
...
mod tests {
    ...
    fn generates_complete_world_from_cosmos_body() {
        let body = cosmos::prelude::CelestialBody::new(
            ...
            cosmos::prelude::CelestialBodyDetails::Telluric(cosmos::prelude::TelluricBodyDetails::new(
                cosmos::prelude::TelluricBodyComposition::Rocky,
                cosmos::prelude::CelestialBodyWorldType::Terrestrial,
                Vec::new(),
                cosmos::prelude::CelestialBodyCoreHeat::ActiveCore,
        ...
        assert_eq!(generated.profile.world_type, CelestialBodyWorldType::Terrestrial);
