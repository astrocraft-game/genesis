...
pub static ELECTROCHEMISTRY_RECIPES: &[Recipe] = &[
    ...
    // ===== BATTERIES (continued) =====
    Recipe { id: 982, name: "NiMH Battery Assembly", category: RecipeCategory::Manufacturing,
        inputs: &[(S::Nickel, 0.4), (S::Magnesium, 0.3), (S::SodiumHydroxide, 0.3)],
        outputs: &[(S::NiMHBattery, 1.0)], byproducts: &[],
        min_temp_c: 20, pressure_atm: 1.0, catalyst: None, duration_hours: 6.0, cross_recipe_group: None },
    Recipe { id: 983, name: "Zinc-Air Battery", category: RecipeCategory::Manufacturing,
        inputs: &[(S::Zinc, 0.6), (S::Oxygen, 0.4)],
        outputs: &[(S::ZincWhite, 1.0)], byproducts: &[],
        min_temp_c: 20, pressure_atm: 1.0, catalyst: None, duration_hours: 4.0, cross_recipe_group: None },
    Recipe { id: 984, name: "Na-S Battery", category: RecipeCategory::Manufacturing,
        inputs: &[(S::Sodium, 0.5), (S::Sulfur, 0.5)],
        outputs: &[(S::SodiumSulfurBattery, 1.0)], byproducts: &[],
        min_temp_c: 320, pressure_atm: 1.0, catalyst: None, duration_hours: 4.0, cross_recipe_group: None },
    Recipe { id: 985, name: "Fe-Air Battery", category: RecipeCategory::Manufacturing,
        inputs: &[(S::Iron, 0.7), (S::Oxygen, 0.3)],
        outputs: &[(S::IronAirBattery, 1.0)], byproducts: &[],
        min_temp_c: 20, pressure_atm: 1.0, catalyst: None, duration_hours: 6.0, cross_recipe_group: None },
    Recipe { id: 986, name: "LFP Battery (LiFePO4)", category: RecipeCategory::Manufacturing,
        inputs: &[(S::Lithium, 0.2), (S::Iron, 0.4), (S::Phosphorus, 0.4)],
        outputs: &[(S::LFPBattery, 1.0)], byproducts: &[],
        min_temp_c: 20, pressure_atm: 1.0, catalyst: None, duration_hours: 8.0, cross_recipe_group: None },
    Recipe { id: 987, name: "Vanadium Flow Battery", category: RecipeCategory::Manufacturing,
        inputs: &[(S::Vanadium, 0.5), (S::SulfuricAcid, 0.5)],
        outputs: &[(S::VanadiumFlowBattery, 1.0)], byproducts: &[],
        min_temp_c: 20, pressure_atm: 1.0, catalyst: None, duration_hours: 10.0, cross_recipe_group: None },

    // ===== ELECTROPLATING (continued) =====
    Recipe { id: 988, name: "Silver Plating", category: RecipeCategory::Manufacturing,
        inputs: &[(S::Silver, 0.01), (S::SodiumCyanide, 0.01), (S::Water, 1.0)],
        outputs: &[(S::SilverPlating, 0.01)], byproducts: &[],
        min_temp_c: 25, pressure_atm: 1.0, catalyst: None, duration_hours: 1.5, cross_recipe_group: None },
    Recipe { id: 989, name: "Tin Plating", category: RecipeCategory::Manufacturing,
        inputs: &[(S::Tin, 0.02), (S::SulfuricAcid, 0.05), (S::Water, 1.0)],
        outputs: &[(S::TinPlating, 0.02)], byproducts: &[],
        min_temp_c: 25, pressure_atm: 1.0, catalyst: None, duration_hours: 2.0, cross_recipe_group: None },
    Recipe { id: 990, name: "Copper Plating", category: RecipeCategory::Manufacturing,
        inputs: &[(S::Copper, 0.02), (S::SulfuricAcid, 0.05), (S::Water, 1.0)],
        outputs: &[(S::CopperPlating, 0.02)], byproducts: &[],
        min_temp_c: 25, pressure_atm: 1.0, catalyst: None, duration_hours: 2.0, cross_recipe_group: None },

    // ===== NUCLEAR DECAY =====
    Recipe { id: 991, name: "U-238 Decay Chain → Pb-206", category: RecipeCategory::PhaseChange,
        inputs: &[(S::Uranium, 1.0)], outputs: &[(S::Lead, 0.97)],
        byproducts: &[(S::Steam, 0.03)], // decay energy placeholder
        min_temp_c: i32::MAX, pressure_atm: 1.0, catalyst: None, duration_hours: 8760000000.0, cross_recipe_group: None },
    Recipe { id: 992, name: "Th-232 Decay Chain → Pb-208", category: RecipeCategory::PhaseChange,
        inputs: &[(S::Thorium, 1.0)], outputs: &[(S::Lead, 0.97)],
        byproducts: &[(S::Steam, 0.03)],
        min_temp_c: i32::MAX, pressure_atm: 1.0, catalyst: None, duration_hours: 8760000000.0, cross_recipe_group: None },
    Recipe { id: 993, name: "K-40 Decay → Ar-40 (Geochronology)", category: RecipeCategory::PhaseChange,
        inputs: &[(S::Potassium, 1.0)], outputs: &[(S::Argon, 0.99)],
        byproducts: &[],
        min_temp_c: i32::MAX, pressure_atm: 1.0, catalyst: None, duration_hours: 8760000000.0, cross_recipe_group: None },
    Recipe { id: 994, name: "C-14 Decay → N-14 (Radiocarbon)", category: RecipeCategory::PhaseChange,
        inputs: &[(S::Carbon, 1.0)], outputs: &[(S::Nitrogen, 1.0)],
        byproducts: &[],
        min_temp_c: i32::MAX, pressure_atm: 1.0, catalyst: None, duration_hours: 50000.0, cross_recipe_group: None },

    // ===== NUCLEAR PRODUCTION =====
    Recipe { id: 995, name: "Co-60 Production (Neutron Activation)", category: RecipeCategory::PhaseChange,
        inputs: &[(S::Cobalt, 1.0)], outputs: &[(S::Cobalt, 1.0)], // Co-60 placeholder
        byproducts: &[(S::Steam, 0.01)],
        min_temp_c: 300, pressure_atm: 1.0, catalyst: None, duration_hours: 8760.0, cross_recipe_group: None },
    Recipe { id: 996, name: "Mo-99/Tc-99m Production (Fission)", category: RecipeCategory::PhaseChange,
        inputs: &[(S::Uranium, 1.0)], outputs: &[(S::Molybdenum, 0.03)],
        byproducts: &[(S::Slag, 0.97)], // fission products
        min_temp_c: 300, pressure_atm: 1.0, catalyst: None, duration_hours: 168.0, cross_recipe_group: None },

    // ===== STELLAR NUCLEOSYNTHESIS (continued) =====
    Recipe { id: 997, name: "Carbon Burning (C+C → Na+He)", category: RecipeCategory::PhaseChange,
        inputs: &[(S::Carbon, 2.0)], outputs: &[(S::Sodium, 1.0)],
        byproducts: &[(S::Steam, 0.5)], // He energy placeholder
        min_temp_c: i32::MAX, pressure_atm: 1000000.0, catalyst: None, duration_hours: 1000.0, cross_recipe_group: None },
    Recipe { id: 998, name: "Oxygen Burning (O+O → Si)", category: RecipeCategory::PhaseChange,
        inputs: &[(S::Oxygen, 2.0)], outputs: &[(S::Silicon, 1.0)],
        byproducts: &[(S::Steam, 0.5)],
        min_temp_c: i32::MAX, pressure_atm: 10000000.0, catalyst: None, duration_hours: 0.5, cross_recipe_group: None },
    Recipe { id: 999, name: "s-Process Slow Neutron Capture (Fe → Pb)", category: RecipeCategory::PhaseChange,
        inputs: &[(S::Iron, 1.0)], outputs: &[(S::Lead, 0.5)],
        byproducts: &[(S::Iron, 0.5)],
        min_temp_c: i32::MAX, pressure_atm: 100000.0, catalyst: None, duration_hours: 876000000.0, cross_recipe_group: None },
];
