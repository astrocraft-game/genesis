...
pub static SPICE_RECIPES: &[Recipe] = &[
    ...
    Recipe {
        id: 1600,
        name: "Vanilla Bean Curing",
        category: RecipeCategory::SpiceProcessing,
    ...
    Recipe {
        id: 1604,
        name: "Green Pepper Processing (Dried)",
        category: RecipeCategory::SpiceProcessing,
    ...
    Recipe {
        id: 1621,
        name: "Coffee Dry Processing (Natural)",
        category: RecipeCategory::SpiceProcessing,
