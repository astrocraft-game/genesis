...
pub static FERMENTATION_RECIPES: &[Recipe] = &[
    ...
    Recipe {
        id: 1300,
        name: "Mead (Traditional)",
        category: RecipeCategory::Fermentation,
    ...
    Recipe {
        id: 1304,
        name: "Pulque (Agave Fermentation)",
        category: RecipeCategory::Fermentation,
    ...
    Recipe {
        id: 1306,
        name: "Kumiss (Fermented Mare's Milk)",
        category: RecipeCategory::Fermentation,
    ...
    Recipe {
        id: 1310,
        name: "Tepache (Pineapple Fermentation)",
        category: RecipeCategory::Fermentation,
    ...
    Recipe {
        id: 1321,
        name: "Miso (White/Shiro, Short Aged)",
        category: RecipeCategory::Fermentation,
        inputs: &[
            (S::SoybeanRaw, 1.0),
            (S::RiceGrain, 1.0),
    ...
    Recipe {
        id: 1326,
        name: "Curtido (Central American Sauerkraut)",
        category: RecipeCategory::Fermentation,
    ...
    Recipe {
        id: 1327,
        name: "Tsukemono (Rice Bran Pickles)",
        category: RecipeCategory::Fermentation,
    ...
    Recipe {
        id: 1329,
        name: "Idli (Steamed Fermented Rice Cake)",
        category: RecipeCategory::Fermentation,
        inputs: &[(S::RiceGrain, 0.75), (S::SoybeanRaw, 0.25), (S::Water, 1.0)],
        outputs: &[(S::Idli, 1.8)],
    ...
    Recipe {
        id: 1330,
        name: "Injera (Teff Sourdough Flatbread)",
        category: RecipeCategory::Fermentation,
    ...
    Recipe {
        id: 1332,
        name: "Black Garlic (Fermented Garlic)",
        category: RecipeCategory::Fermentation,
        inputs: &[(S::Water, 1.0)],
    ...
    Recipe {
        id: 1335,
        name: "Shrimp Paste (Belacan/Kapi)",
        category: RecipeCategory::Fermentation,
    ...
    Recipe {
        id: 1340,
        name: "Kefir (Traditional Grain)",
        category: RecipeCategory::DairyProcessing,
        inputs: &[(S::Milk, 1.0), (S::KefirGrains, 0.05)],
        outputs: &[(S::Kefir, 1.0)],
    ...
    Recipe {
        id: 1341,
        name: "Skyr (Icelandic Strained Yogurt)",
        category: RecipeCategory::DairyProcessing,
        inputs: &[
            (S::Milk, 4.0),
            (S::StarterCulture, 0.05),
            (S::RennetEnzyme, 0.001),
        ],
        outputs: &[(S::Skyr, 1.0)],
