...
pub static CHEESE_RECIPES: &[Recipe] = &[
    ...
    Recipe {
        id: 1404,
        name: "Parmesan Cheese (Parmigiano-Reggiano)",
        category: RecipeCategory::DairyProcessing,
        inputs: &[
            (S::Milk, 16.0),
            (S::StarterCulture, 0.01),
            (S::RennetEnzyme, 0.002),
            (S::Salt, 0.1),
        ],
    ...
    Recipe {
        id: 1408,
        name: "Swiss / Emmental Cheese",
        category: RecipeCategory::DairyProcessing,
        inputs: &[
            (S::Milk, 12.0),
            (S::StarterCulture, 0.015),
            (S::RennetEnzyme, 0.002),
            (S::Salt, 0.04),
        ],
