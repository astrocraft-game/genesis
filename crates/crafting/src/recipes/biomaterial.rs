...
pub static BIOMATERIAL_RECIPES: &[Recipe] = &[
    ...
    Recipe { id: 1800, name: "Chrome Tanned Leather", category: RecipeCategory::LeatherTanning,
        inputs: &[(S::AnimalHide, 3.0), (S::ChromiumSulfate, 0.1), (S::SulfuricAcid, 0.05),
                   (S::Salt, 0.2), (S::Water, 5.0)],
        outputs: &[(S::LeatherProduct, 1.0)],
        byproducts: &[(S::Water, 5.0)],
        min_temp_c: 30, pressure_atm: 1.0, catalyst: None, duration_hours: 48.0,
    ...
    Recipe { id: 1801, name: "Vegetable Tanned Leather", category: RecipeCategory::LeatherTanning,
        inputs: &[(S::AnimalHide, 3.0), (S::Tannin, 0.8), (S::Water, 10.0)],
        outputs: &[(S::LeatherProduct, 1.0)],
        byproducts: &[(S::Water, 10.0)],
        min_temp_c: 22, pressure_atm: 1.0, catalyst: None, duration_hours: 1440.0,
        cross_recipe_group: Some(CRG_LEATHER) },
    ...
    Recipe { id: 1802, name: "Brain Tanned Leather", category: RecipeCategory::LeatherTanning,
        inputs: &[(S::AnimalHide, 2.0), (S::BrainTissue, 0.3), (S::Water, 3.0)],
        outputs: &[(S::BrainTannedLeather, 1.0)],
        byproducts: &[(S::Water, 3.0)],
        min_temp_c: 25, pressure_atm: 1.0, catalyst: None, duration_hours: 96.0,
        cross_recipe_group: Some(CRG_LEATHER) },
    ...
    Recipe { id: 1803, name: "Alum Tanned Leather (Tawing)", category: RecipeCategory::LeatherTanning,
        inputs: &[(S::AnimalHide, 2.0), (S::AlumCompound, 0.3), (S::Salt, 0.2), (S::Water, 5.0)],
        outputs: &[(S::AlumTannedLeather, 1.0)],
        byproducts: &[(S::Water, 5.0)],
        min_temp_c: 22, pressure_atm: 1.0, catalyst: None, duration_hours: 504.0,
        cross_recipe_group: Some(CRG_LEATHER) },
    ...
    Recipe { id: 1804, name: "Chamois Leather (Oil Tanning)", category: RecipeCategory::LeatherTanning,
        inputs: &[(S::AnimalHide, 2.0), (S::OliveOil, 0.5), (S::Water, 3.0)],
        outputs: &[(S::ChamoisLeather, 1.0)],
        byproducts: &[(S::Water, 3.0)],
        min_temp_c: 45, pressure_atm: 1.0, catalyst: None, duration_hours: 168.0,
        cross_recipe_group: Some(CRG_LEATHER) },
    ...
    Recipe { id: 1805, name: "Synthetic Leather (PU)", category: RecipeCategory::LeatherTanning,
        inputs: &[(S::PolyesterFiber, 0.5), (S::Ethylene, 0.5), (S::Water, 1.0)],
        outputs: &[(S::SyntheticLeather, 1.0)],
        byproducts: &[(S::Water, 0.5)],
        min_temp_c: 100, pressure_atm: 1.0, catalyst: None, duration_hours: 3.0,
    ...
    Recipe { id: 1810, name: "Sulfite Pulp", category: RecipeCategory::PaperPulping,
        inputs: &[(S::WoodChips, 2.5), (S::SulfuricAcid, 0.2), (S::Water, 5.0)],
        outputs: &[(S::SulfitePulp, 1.0)],
        byproducts: &[(S::Water, 4.0)],
        min_temp_c: 145, pressure_atm: 7.0, catalyst: None, duration_hours: 9.0,
    ...
    Recipe { id: 1811, name: "Mechanical Pulp (Groundwood)", category: RecipeCategory::PaperPulping,
    ...
    Recipe { id: 1812, name: "Thermomechanical Pulp (TMP)", category: RecipeCategory::PaperPulping,
        inputs: &[(S::WoodChips, 1.1), (S::Steam, 0.5)],
        outputs: &[(S::ThermoMechanicalPulp, 1.0)],
        byproducts: &[(S::Water, 0.3)],
        min_temp_c: 120, pressure_atm: 3.0, catalyst: None, duration_hours: 1.5,
        cross_recipe_group: Some(CRG_PAPER) },
    ...
    Recipe { id: 1813, name: "Recycled Paper Pulping", category: RecipeCategory::PaperPulping,
        inputs: &[(S::PaperProduct, 1.2), (S::Water, 5.0), (S::SodiumHydroxide, 0.05)],
        outputs: &[(S::RecycledPaper, 1.0)],
        byproducts: &[(S::Water, 4.5)],
        min_temp_c: 45, pressure_atm: 1.0, catalyst: None, duration_hours: 3.0,
        cross_recipe_group: Some(CRG_PAPER) },
    ...
    Recipe { id: 1814, name: "Rice Paper", category: RecipeCategory::PaperPulping,
        inputs: &[(S::StrawFiber, 2.0), (S::SodiumHydroxide, 0.1), (S::Water, 5.0)],
        outputs: &[(S::RicePaper, 1.0)],
        byproducts: &[(S::Water, 4.5)],
        min_temp_c: 100, pressure_atm: 1.0, catalyst: None, duration_hours: 6.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1815, name: "Handmade Paper", category: RecipeCategory::PaperPulping,
    ...
    Recipe { id: 1816, name: "Papyrus", category: RecipeCategory::PaperPulping,
        inputs: &[(S::StrawFiber, 2.0), (S::Water, 3.0)],
        outputs: &[(S::Papyrus, 1.0)],
        byproducts: &[(S::Water, 3.0)],
        min_temp_c: 25, pressure_atm: 1.0, catalyst: None, duration_hours: 72.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1817, name: "Bark Cloth (Tapa)", category: RecipeCategory::PaperPulping,
        inputs: &[(S::WoodLogs, 3.0), (S::Water, 3.0)],
        outputs: &[(S::BarkCloth, 1.0)],
        byproducts: &[(S::Water, 3.0), (S::WoodChips, 1.5)],
        min_temp_c: 25, pressure_atm: 1.0, catalyst: None, duration_hours: 48.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1830, name: "Bone Meal Production", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::AnimalBones, 3.0), (S::Steam, 1.0)],
        outputs: &[(S::BoneMeal, 1.0)],
        byproducts: &[(S::Water, 1.5)],
        min_temp_c: 133, pressure_atm: 3.0, catalyst: None, duration_hours: 3.0,
    ...
    Recipe { id: 1831, name: "Blood Meal Production", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::AnimalBlood, 5.0)],
        outputs: &[(S::BloodMeal, 1.0)],
        byproducts: &[(S::Water, 3.5)],
        min_temp_c: 120, pressure_atm: 1.0, catalyst: None, duration_hours: 3.0,
        cross_recipe_group: Some(CRG_ANIMAL_MEAL) },
    ...
    Recipe { id: 1832, name: "Fish Meal Production", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::FishOffal, 5.0), (S::Steam, 0.5)],
        outputs: &[(S::FishMeal, 1.0)],
        byproducts: &[(S::OliveOil, 0.3), (S::Water, 3.0)],
        min_temp_c: 90, pressure_atm: 1.0, catalyst: None, duration_hours: 5.0,
        cross_recipe_group: Some(CRG_ANIMAL_MEAL) },
    ...
    Recipe { id: 1833, name: "Feather Meal Production", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::PoultryFeathers, 5.0), (S::Steam, 1.0)],
        outputs: &[(S::FeatherMeal, 1.0)],
        byproducts: &[(S::Water, 3.5)],
        min_temp_c: 140, pressure_atm: 3.5, catalyst: None, duration_hours: 3.0,
        cross_recipe_group: Some(CRG_ANIMAL_MEAL) },
    ...
    Recipe { id: 1840, name: "Gelatin Extraction", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::AnimalBones, 3.0), (S::Water, 5.0), (S::HydrochloricAcid, 0.1)],
        outputs: &[(S::Gelatin, 1.0)],
        byproducts: &[(S::Water, 5.0), (S::BoneMeal, 0.5)],
        min_temp_c: 65, pressure_atm: 1.0, catalyst: None, duration_hours: 12.0,
    ...
    Recipe { id: 1841, name: "Isinglass Production", category: RecipeCategory::BiologicalMaterial,
    ...
    Recipe { id: 1842, name: "Carrageenan Extraction", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::Seaweed, 5.0), (S::Water, 10.0), (S::SodiumHydroxide, 0.1)],
        outputs: &[(S::Carrageenan, 1.0)],
        byproducts: &[(S::Water, 12.0)],
        min_temp_c: 75, pressure_atm: 1.0, catalyst: None, duration_hours: 5.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1843, name: "Agar-Agar Extraction", category: RecipeCategory::BiologicalMaterial,
    ...
    Recipe { id: 1844, name: "Pectin Extraction", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::FruitPeel, 5.0), (S::Water, 5.0), (S::HydrochloricAcid, 0.1)],
        outputs: &[(S::Pectin, 1.0)],
        byproducts: &[(S::Water, 7.0)],
        min_temp_c: 85, pressure_atm: 1.0, catalyst: None, duration_hours: 4.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1850, name: "Shellac Processing", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::LacInsectResin, 3.0), (S::Water, 2.0)],
        outputs: &[(S::Shellac, 1.0)],
        byproducts: &[(S::Water, 2.0), (S::IndigoDye, 0.05)],
        min_temp_c: 78, pressure_atm: 1.0, catalyst: None, duration_hours: 6.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1851, name: "Beeswax Rendering", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::Honey, 0.5), (S::Water, 2.0)],
        outputs: &[(S::Beeswax, 1.0)],
        byproducts: &[(S::Honey, 0.3), (S::Water, 1.0)],
        min_temp_c: 65, pressure_atm: 1.0, catalyst: None, duration_hours: 3.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1852, name: "Lanolin Extraction (Wool Scouring)", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::RawWool, 5.0), (S::Water, 10.0), (S::SoapProduct, 0.2)],
        outputs: &[(S::Lanolin, 1.0)],
        byproducts: &[(S::WoolFiber, 3.5), (S::Water, 10.0)],
        min_temp_c: 60, pressure_atm: 1.0, catalyst: None, duration_hours: 3.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1860, name: "Hide Glue Production", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::AnimalHide, 2.0), (S::Water, 5.0), (S::SlakedLite, 0.1)],
        outputs: &[(S::HideGlue, 1.0)],
        byproducts: &[(S::Water, 4.5)],
        min_temp_c: 70, pressure_atm: 1.0, catalyst: None, duration_hours: 48.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1861, name: "Casein Glue Production", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::Milk, 5.0), (S::Vinegar, 0.1), (S::SlakedLite, 0.05)],
        outputs: &[(S::CaseinGlue, 1.0)],
        byproducts: &[(S::Whey, 3.5)],
        min_temp_c: 60, pressure_atm: 1.0, catalyst: None, duration_hours: 4.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1862, name: "Starch Paste Adhesive", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::Starch, 0.3), (S::Water, 1.0)],
        outputs: &[(S::StarchPaste, 1.2)],
        byproducts: &[],
        min_temp_c: 80, pressure_atm: 1.0, catalyst: None, duration_hours: 0.5,
        cross_recipe_group: None },
    ...
    Recipe { id: 1863, name: "Birch Bark Tar (Dry Distillation)", category: RecipeCategory::BiologicalMaterial,
        inputs: &[(S::BirchBark, 3.0)],
        outputs: &[(S::BirchBarkTar, 1.0)],
        byproducts: &[(S::Charcoal, 0.5), (S::CarbonDioxide, 0.3)],
        min_temp_c: 350, pressure_atm: 1.0, catalyst: None, duration_hours: 4.0,
        cross_recipe_group: None },
];
