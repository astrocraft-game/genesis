...
pub static TEXTILE_RECIPES: &[Recipe] = &[
    ...
    Recipe { id: 1700, name: "Cotton Ginning and Spinning", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::RawCottonBoll, 3.0)],
        outputs: &[(S::CottonFiber, 1.0)],
        byproducts: &[(S::OilSeed, 1.5), (S::StrawFiber, 0.3)],
        min_temp_c: 20, pressure_atm: 1.0, catalyst: None, duration_hours: 8.0,
    ...
    Recipe { id: 1701, name: "Wool Scouring and Spinning", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::RawWool, 2.5), (S::Water, 5.0), (S::SoapProduct, 0.1)],
        outputs: &[(S::WoolFiber, 1.0)],
        byproducts: &[(S::Lanolin, 0.3), (S::Water, 5.0)],
        min_temp_c: 60, pressure_atm: 1.0, catalyst: None, duration_hours: 12.0,
    ...
    Recipe { id: 1702, name: "Silk Reeling and Degumming", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::SilkCocoon, 6.0), (S::Water, 10.0)],
        outputs: &[(S::SilkFiber, 1.0)],
        byproducts: &[(S::Water, 12.0)],
        min_temp_c: 97, pressure_atm: 1.0, catalyst: None, duration_hours: 12.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1703, name: "Linen Flax Water Retting", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::FlaxStalk, 4.0), (S::Water, 10.0)],
        outputs: &[(S::LinenFiber, 1.0)],
        byproducts: &[(S::Water, 10.0), (S::StrawFiber, 2.5)],
        min_temp_c: 30, pressure_atm: 1.0, catalyst: None, duration_hours: 264.0,
        cross_recipe_group: Some(CRG_LINEN) },

    Recipe { id: 1704, name: "Linen Flax Dew Retting", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::FlaxStalk, 4.0)],
        outputs: &[(S::LinenFiber, 1.0)],
        byproducts: &[(S::StrawFiber, 2.5)],
        min_temp_c: 20, pressure_atm: 1.0, catalyst: None, duration_hours: 600.0,
        cross_recipe_group: Some(CRG_LINEN) },
    ...
    Recipe { id: 1705, name: "Hemp Fiber Water Retting", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::HempStalk, 4.0), (S::Water, 10.0)],
        outputs: &[(S::HempFiber, 1.0)],
        byproducts: &[(S::Water, 10.0), (S::StrawFiber, 2.5)],
        min_temp_c: 30, pressure_atm: 1.0, catalyst: None, duration_hours: 240.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1706, name: "Jute Fiber Retting", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::JuteStalk, 5.0), (S::Water, 10.0)],
        outputs: &[(S::JuteFiber, 1.0)],
        byproducts: &[(S::Water, 10.0), (S::StrawFiber, 3.5)],
        min_temp_c: 30, pressure_atm: 1.0, catalyst: None, duration_hours: 480.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1707, name: "Sisal Fiber Decortication", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::StrawFiber, 5.0), (S::Water, 3.0)],
        outputs: &[(S::SisalFiber, 1.0)],
        byproducts: &[(S::Water, 5.0), (S::StrawFiber, 1.5)],
        min_temp_c: 35, pressure_atm: 1.0, catalyst: None, duration_hours: 36.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1708, name: "Coir Fiber Retting", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::StrawFiber, 5.0), (S::Water, 10.0)],
        outputs: &[(S::CoirFiber, 1.0)],
        byproducts: &[(S::Water, 10.0), (S::StrawFiber, 3.5)],
        min_temp_c: 28, pressure_atm: 1.0, catalyst: None, duration_hours: 4320.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1709, name: "Ramie Fiber Degumming", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::StrawFiber, 4.0), (S::SodiumHydroxide, 0.15), (S::Water, 5.0)],
        outputs: &[(S::RamieFiber, 1.0)],
        byproducts: &[(S::Water, 6.0)],
        min_temp_c: 95, pressure_atm: 1.0, catalyst: None, duration_hours: 4.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1710, name: "Bamboo Fiber (Chemical/Viscose)", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::Cellulose, 2.0), (S::SodiumHydroxide, 0.5), (S::Water, 5.0)],
    ...
    Recipe { id: 1711, name: "Kapok Fiber Extraction", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::StrawFiber, 3.0)],
        outputs: &[(S::KapokFiber, 1.0)],
        byproducts: &[(S::OilSeed, 1.0), (S::StrawFiber, 0.5)],
        min_temp_c: 25, pressure_atm: 1.0, catalyst: None, duration_hours: 3.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1720, name: "Rayon / Viscose Fiber", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::WoodPulpRaw, 1.5), (S::SodiumHydroxide, 0.5), (S::SulfuricAcid, 0.3), (S::Water, 5.0)],
        outputs: &[(S::RayonFiber, 1.0)],
        byproducts: &[(S::Water, 4.5), (S::SulfurDioxide, 0.1)],
        min_temp_c: 35, pressure_atm: 1.0, catalyst: None, duration_hours: 48.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1721, name: "Modal Fiber", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::WoodPulpRaw, 1.5), (S::SodiumHydroxide, 0.5), (S::SulfuricAcid, 0.3), (S::Water, 5.0)],
    ...
    Recipe { id: 1722, name: "Lyocell / Tencel Fiber", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::WoodPulpRaw, 1.5), (S::Water, 5.0)],
        outputs: &[(S::LyocellFiber, 1.0)],
        byproducts: &[(S::Water, 4.5)],
        min_temp_c: 100, pressure_atm: 1.0, catalyst: None, duration_hours: 10.0,
        cross_recipe_group: None },
    ...
    Recipe { id: 1723, name: "Spandex / Elastane Fiber", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::Ethylene, 0.6), (S::Butadiene, 0.4)],
        outputs: &[(S::SpandexFiber, 1.0)],
        byproducts: &[],
        min_temp_c: 200, pressure_atm: 1.0, catalyst: None, duration_hours: 4.0,
        cross_recipe_group: None },

    // --- Polypropylene Fiber ---
    // Melt-spin polypropylene pellets through spinneret, then draw/stretch.
    // Temperature: 220-280C (melt spinning), Duration: 1-2 hours
    Recipe { id: 1724, name: "Polypropylene Fiber Spinning", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::Polypropylene, 1.0)],
        outputs: &[(S::PolypropyleneFiber, 0.98)],
        byproducts: &[],
        min_temp_c: 250, pressure_atm: 1.0, catalyst: None, duration_hours: 1.5,
        cross_recipe_group: None },
    ...
    Recipe { id: 1725, name: "Acrylic Fiber Spinning", category: RecipeCategory::TextileProcessing,
        inputs: &[(S::Acrylonitrile, 1.0), (S::Water, 2.0)],
        outputs: &[(S::AcrylicFiber, 0.95)],
        byproducts: &[(S::Water, 2.0)],
        min_temp_c: 65, pressure_atm: 1.0, catalyst: None, duration_hours: 6.0,
        cross_recipe_group: None },
];
