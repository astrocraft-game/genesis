...
pub static EXTRACTION_RECIPES: &[Recipe] = &[
    ...
    Recipe {
        id: 1460,
        name: "Metallurgical Silicon (Carbothermic Reduction)",
        category: RecipeCategory::Extraction,
        inputs: &[(S::SilicaSand, 3.0), (S::Carbon, 1.5)],
        outputs: &[(S::Silicon, 1.0)],
        byproducts: &[(S::CarbonDioxide, 2.0), (S::Slag, 1.0)],
        min_temp_c: 1900,
        pressure_atm: 1.0,
        catalyst: None,
        duration_hours: 6.0,
    ...
    Recipe {
        id: 1461,
        name: "Polysilicon (Siemens Process)",
        category: RecipeCategory::ChemicalSynthesis,
        inputs: &[(S::Silicon, 1.0), (S::HydrochloricAcid, 0.5)],
        outputs: &[(S::Polysilicon, 0.9)],
        byproducts: &[(S::Wastewater, 0.5)],
        min_temp_c: 1100,
        pressure_atm: 1.0,
        catalyst: None,
        duration_hours: 24.0,
    ...
    Recipe {
        id: 1462,
        name: "Silicon Wafer (Czochralski Crystal + Slicing)",
        category: RecipeCategory::Manufacturing,
        inputs: &[(S::Polysilicon, 1.0)],
        outputs: &[(S::SiliconWafer, 0.8)],
        byproducts: &[(S::Silicon, 0.15)],
        min_temp_c: 1420,
        pressure_atm: 1.0,
        catalyst: None,
        duration_hours: 48.0,
    ...
    Recipe {
        id: 1463,
        name: "Microchip Fabrication (Doping + Lithography)",
        category: RecipeCategory::Manufacturing,
        inputs: &[(S::SiliconWafer, 1.0), (S::Arsenic, 0.001), (S::Gold, 0.01)],
        outputs: &[(S::MicroChip, 0.5)],
        byproducts: &[(S::ToxicSludge, 0.1)],
        min_temp_c: 400,
        pressure_atm: 0.001,
        catalyst: None,
        duration_hours: 72.0,
    ...
    Recipe {
        id: 141,
        name: "Rare Earth Extraction (Bastnaesite)",
        category: RecipeCategory::Extraction,
        inputs: &[(S::Bastnaesite, 5.0), (S::HydrochloricAcid, 1.0)],
        outputs: &[(S::RareEarthMix, 1.2)],
        byproducts: &[(S::Tailings, 3.0), (S::CarbonDioxide, 0.5)],
        min_temp_c: 200,
        pressure_atm: 2.0,
        catalyst: None,
        duration_hours: 6.0,
        cross_recipe_group: Some(140),
    },
    // ===== REE SEPARATION (solvent extraction from RareEarthMix) =====
    Recipe {
        id: 1401,
        name: "REE Separation: Light REEs (La, Ce, Pr, Nd)",
        category: RecipeCategory::ChemicalSynthesis,
        inputs: &[(S::RareEarthMix, 1.0), (S::HydrochloricAcid, 0.5)],
        outputs: &[
            (S::Cerium, 0.35),
            (S::Lanthanum, 0.25),
            (S::Neodymium, 0.20),
    ...
    Recipe {
        id: 1402,
        name: "REE Separation: Medium REEs (Sm, Eu, Gd)",
        category: RecipeCategory::ChemicalSynthesis,
        inputs: &[(S::RareEarthMix, 1.0), (S::NitricAcid, 0.5)],
        outputs: &[
            (S::Samarium, 0.06),
            (S::Europium, 0.02),
            (S::Gadolinium, 0.05),
        ],
        byproducts: &[(S::Wastewater, 0.8)],
        min_temp_c: 90,
        pressure_atm: 1.0,
        catalyst: None,
        duration_hours: 16.0,
    ...
    Recipe {
        id: 1403,
        name: "REE Separation: Heavy REEs (Dy, Y, Sc)",
        category: RecipeCategory::ChemicalSynthesis,
        inputs: &[(S::RareEarthMix, 1.0), (S::SulfuricAcid, 0.5)],
        outputs: &[
            (S::Dysprosium, 0.03),
            (S::Yttrium, 0.04),
            (S::Scandium, 0.01),
        ],
        byproducts: &[(S::Wastewater, 0.9)],
        min_temp_c: 100,
        pressure_atm: 2.0,
        catalyst: None,
        duration_hours: 24.0,
    ...
    Recipe {
        id: 1420,
        name: "Ni-Cu Matte to PGM Concentrate",
        category: RecipeCategory::Extraction,
        inputs: &[
            (S::Nickel, 100.0),
            (S::Copper, 50.0),
        ...
        outputs: &[(S::PGMConcentrate, 0.5)],
        byproducts: &[(S::Slag, 20.0), (S::Wastewater, 30.0)],
        min_temp_c: 1200,
        pressure_atm: 3.0,
        catalyst: None,
        duration_hours: 48.0,
    ...
    Recipe {
        id: 1421,
        name: "PGM Separation: Platinum + Palladium",
        category: RecipeCategory::ChemicalSynthesis,
        inputs: &[(S::PGMConcentrate, 1.0), (S::HydrochloricAcid, 2.0)],
        outputs: &[(S::Platinum, 0.35), (S::Palladium, 0.30)],
        byproducts: &[(S::Wastewater, 2.0)],
        min_temp_c: 100,
        pressure_atm: 1.0,
        catalyst: None,
        duration_hours: 24.0,
    ...
    Recipe {
        id: 1422,
        name: "PGM Separation: Rhodium + Iridium",
        category: RecipeCategory::ChemicalSynthesis,
        inputs: &[(S::PGMConcentrate, 1.0), (S::NitricAcid, 2.0)],
        outputs: &[(S::Rhodium, 0.10), (S::Iridium, 0.08)],
        byproducts: &[(S::Wastewater, 2.5)],
        min_temp_c: 120,
        pressure_atm: 1.0,
        catalyst: None,
        duration_hours: 36.0,
    ...
    Recipe {
        id: 1423,
        name: "PGM Separation: Osmium + Ruthenium",
        category: RecipeCategory::ChemicalSynthesis,
        inputs: &[(S::PGMConcentrate, 1.0), (S::SodiumHydroxide, 1.5)],
        outputs: &[(S::Osmium, 0.05), (S::Ruthenium, 0.07)],
        byproducts: &[(S::Wastewater, 2.0)],
        min_temp_c: 150,
        pressure_atm: 2.0,
        catalyst: None,
