...
pub static CONSTRUCTION_RECIPES: &[Recipe] = &[
    ...
    Recipe {
        ...
        catalyst: None,
        duration_hours: 4.0,
        cross_recipe_group: Some(CRG_CEMENT),
    },
    Recipe {
        id: 406,
        name: "Cement from Clinker",
        category: RecipeCategory::Construction,
    ...
    Recipe {
        ...
        catalyst: None,
        duration_hours: 672.0,
        cross_recipe_group: Some(CRG_BRICK),
    },
    Recipe {
        id: 421,
    ...
    Recipe {
        ...
        catalyst: None,
        duration_hours: 0.5,
        cross_recipe_group: Some(CRG_MORTAR),
    },
    Recipe {
        id: 426,
        name: "Cement Mortar",
    ...
    Recipe {
        ...
        catalyst: None,
        duration_hours: 24.0,
        cross_recipe_group: Some(CRG_GLASS),
    },
    Recipe {
        id: 441,
    ...
    Recipe {
        id: 472,
        name: "Earthenware (Low-fire Pottery)",
        category: RecipeCategory::Construction,
    ...
    Recipe {
        id: 473,
        name: "Stoneware (High-fire Pottery)",
        category: RecipeCategory::Construction,
